Main control flow of this project 
Blynk App (Joystick)
        ↓
communication.py
        ↓
main.py (control logic)
        ↓
dc_motor.py
        ↓
DRV8833 → Motors
